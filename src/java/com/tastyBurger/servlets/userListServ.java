/*
 * This is the user list servlet wich will get the user list for admin
 */
 ...
 * @author VBlue
 */
@WebServlet(name = "userListServ", urlPatterns = {"/userListServ"})
public class userListServ extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<customerBean> users = cusBO.getAllUsers();
