...
<ul class="breadcrumb">
  ...
  <li><a href="/TastyBurger/orderListServ?linkValue=2">Delivery List</a></li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <select class="form-control" name="updateStatus" id="sel1" style="width: 9em;">
                                    <option value="on delivery"><%= o.getStatus() %></option>
                        ...
                        <td>
                            ...
                            <td>
                                <a href="/TastyBurger/employee/orderdetail.jsp">detail</a>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
