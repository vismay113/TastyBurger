                ...
                <header>
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right text-center">
                            <li><a href="/TastyBurger/profile.jsp" class="text-center">Profile</a></li>
...
<ul class="breadcrumb">
  <li><a href="/TastyBurger/employee/index.jsp">Employee Home</a></li>
            ...
            <ul class="list-group text-center">
                <li class="list-group-item"><a href="/TastyBurger/orderListServ?linkValue=2">Delivery List</a></li>
                <li class="list-group-item"><a href="/TastyBurger/orderListServ?linkValue=1">Order List</a></li>
