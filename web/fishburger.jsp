        ...
        <div class="tastyburger-content">
            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Fish Burgers </div>
                    <div class="panel-body"> 
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/fish/fishlover.jpg" alt="fishlover">
                                    <div class="caption">
                                        <h3>Fish Lover</h3>
                                         <h4>$6.00</h4>
                                         
                                        <p>Burger Buns, Fresh fish fillet, Eggs, Butter, Lettuce, Tomato, Avocado, Tartare sauce</p>
                                        <input type="hidden" name="burgerName" value="Fish Lover" />
                                        <input type="hidden" name="burgerPrice" value="6" />
                                        <input type="hidden" name="pageName" value="fishburger" />
                                        <br>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/fish/fishking.jpg" alt="fishking">
                                    <div class="caption">
                                        <h3>Fish King</h3>
                                        <h4>$5.00</h4>
                                        <p>Burger Turkish Buns, Two fish fillets, Tartare sauce, Sweet Smoked Paprika, Onion powder, Salt</p>
                                        <input type="hidden" name="burgerName" value="Fish King" />
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/fish/fishlong.jpg" alt="fishlong">
                                    <div class="caption">
                                        <h3>Fish Long</h3>
                                           <h4>$5.00</h4>
                                        <p>Burger Buns, Fresh fish fillet, Eggs, Olive oil, Lettuce, Tomato, Tartare sauce, Finely chopped flat leaf parsley</p>
                                        <input type="hidden" name="burgerName" value="Fish Long" />
                                        <input type="hidden" name="burgerPrice" value="5" />
                                        <input type="hidden" name="pageName" value="fishburger" />
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
