...
<html lang="en">
    <head>
        ...
        <!--Google API Key ID: AIzaSyA5jg7nHdrvuPAhVWjfbWaERGC3fNEPBuE -->
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5jg7nHdrvuPAhVWjfbWaERGC3fNEPBuE&callback=initMap">
        </script>
    ...
    <body>
                        ...
                        <ul class="nav navbar-nav navbar-left text-center"> 
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/TastyBurger/shoppingcart.jsp" class="text-center">Shopping Cart</a></li>
                                </ul>
                            </li>
        ...
        <div class="jumbotron tastyburger-slider">
            <div class="container">
                ...
                <div class="col-md-6">
                    <p class="glyphicon glyphicon-envelope"><span> </span>info@tastyburger1.com.au</p>
                    <br>
                    <p class="glyphicon glyphicon-earphone"><span> </span>(07) 3312-1234</p>

                    <br><br>

                    <p> Or fill in the form below </p>
                    <form style="border-style: ridge; padding: 1em;">

                        <div class="form-group">

                            <input type="text" class="form-control" id="contactInputName" placeholder="Name">
                        </div>

                        <div class="form-group">

                            <input type="email" class="form-control" id="contactInputEmail1" placeholder="Email">
                        </div>
                        <div>

                            <textarea class="form-control" rows="5" placeholder="Message (maximum 500 words)" maxlength="500"></textarea>
                ...
                <div class="col-md-6" >
                    <h3> Location </h3>
                    <p>160 Ann Street, Brisbane QLD 4000, Australia </p>
                    <div id="map"></div>
