        ...
        <div class="tastyburger-content">
            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Vegetarian Burger </div>
                    <div class="panel-body"> 
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-md-12">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/vegetarian/vegetarian.jpg" alt="vegetarian">
                                    <div class="caption">
                                        <h3>Vegetarian Burger</h3>
                                        <h4>$5.00</h4>

                                        <p>Burger Buns, Falafel, Cheese, Lettuce, Tomato, Onion, Pickle, Mustard, Mayonnaise, Tomato sauce </p>
                                        <input type="hidden" name="burgerName" value="Vegetarian Burger" />
                                        <input type="hidden" name="burgerPrice" value="5" />
                                        <input type="hidden" name="pageName" value="vegetarian" />
