...
<html lang="en">
    <head>
        ...
        <%
            List<customerBean> users = (List<customerBean>)session.getAttribute("users");
        %>
        <%
            String addValue = request.getParameter("reactValue");
            if(addValue != null && !"".equals(addValue)) {
                ...
                if(addValue1 == 1) {
                    ...
                    out.println("<script>alert('Reactivation mail sent to user successfully');</script>");
                }
            }
        %>
        ...
        <nav class="navbar navbar-inverse">
            ...
            <div class="container">
                <div class="navbar-header ">
                    <a class="navbar-brand" href="/admin/admin.jsp"> <img class="logo-small" src="/TastyBurger/img/logo.png" alt="logo"></a>
...
<ul class="breadcrumb">
  <li><a href="/TastyBurger/admin/admin.jsp">Admin Console</a></li>
  <li><a href="/TastyBurger/userListServ">User List </a><li>
 ...
 <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Phone</th>
                        <th>Reactivate Profile</th>


                    </tr>
                </thead>
                <tbody>
                    <% for (customerBean c: users) { %>
                    <tr>
                        <td>
                            <input type="hidden" name="cus_id" value="<%= c.getId() %>" /> 
                            <%= c.getId() %>
                        </td>
                        ...
                        <td><a href="/TastyBurger/mailServ?mailId=<%= c.getEmail() %>">Reactivate</a></td>
                    </tr>
                    <% } %>
