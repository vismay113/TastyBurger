                                            ...
                                            <li class="col-lg-14 login-menu">
                                                ...
                                                <form id="ajax-login-form" name="loginForm" action="logoutServ" method="get" role="form" autocomplete="off">
                                                    ...
                                                    <div class="col-xs-5 pull-right">
                                                                <input type="button" name="profile" id="loggedProfile" tabindex="4" class="form-control btn btn-success" value="Profile">
                                                            </div><br />

                                                            <div class="col-xs-5 pull-right">
                                                                <input type="button" name="pastOrders" id="userPastOrders" tabindex="4" class="form-control btn btn-success" value="Past Orders" onclick="window.location.href='/TastyBurger/profile.jsp'">
                                                            </div><br />
        ...
        <div class="tastyburger-content">
            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Beef Burgers </div>
                    <div class="panel-body"> 
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/beef/burgerman.jpg" alt="burgerman">
                                    <div class="caption">
                                        <h3>Burger Man</h3>
                                         <h4>$5.00</h4>
                                         
                                        <p>Burger Buns, Beef, Cheese, Lettuce, Tomato, Onion, Pickle, Mustard, Mayonnaise, Tomato sauce </p>
                                        <input type="hidden" name="burgerName" value="Burger Man" />
                                        <input type="hidden" name="burgerPrice" value="5" />
                                        <input type="hidden" name="pageName" value="beefburger" />
                                         <br>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/beef/passionburger.jpg" alt="passionburger">
                                    <div class="caption">
                                        <h3>Passion Burger</h3>
                                        <h4>$4</h4>
                                        <input type="hidden" name="burgerName" value="Passion Burger" />
                                        <input type="hidden" name="burgerPrice" value="4" />
                                        <input type="hidden" name="pageName" value="beefburger" />
                                        <p>Burger Buns, Beef, Cheese, Lettuce, Bacon, Caramelised Onions, Pickle, BBQ Sauce, Mayonnaise</p>
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/beef/cheeseburger.jpg" alt="cheeseburger">
                                    <div class="caption">
                                        <h3>Cheese Burger</h3>
                                           <h4>$3</h4>
                                           <input type="hidden" name="burgerName" value="Cheese Burger" />
                                           <input type="hidden" name="burgerPrice" value="3" />
                                           <input type="hidden" name="pageName" value="beefburger" />
                                        <p>Burger Buns, Beef, Cheese, Bacon, Onion Rings, Chilli Mayo & Jalapenos</p>
                                        <br>
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
                                </div>
