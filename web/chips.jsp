        ...
        <div class="tastyburger-content">
            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Chips </div>
                    <div class="panel-body"> 
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/chips/chipslarge.jpg" alt="chipslarge">
                                    <div class="caption">
                                        <h3>Chips Small</h3>
                                         <h4>$1.00</h4>
                                         
                                        <p>Chips, Cajun Salt </p>
                                        <input type="hidden" name="burgerName" value="Chips Small" />
                                        <input type="hidden" name="burgerPrice" value="1" />
                                        <input type="hidden" name="pageName" value="chips" />
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h4>$2.00</h4>
                                        <p>Chips, Cajun Salt</p>
                                        <input type="hidden" name="burgerName" value="Chips Medium" />
                                        <input type="hidden" name="burgerPrice" value="2" />
                                        <input type="hidden" name="pageName" value="chips" />
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
                                </div>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3>Chips Large</h3>
                                           <h4>$3.00</h4>
                                        <p>Chips, Cajun Salt</p>
                                        <input type="hidden" name="burgerName" value="Chips Large" />
