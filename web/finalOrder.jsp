...
<html lang="en">
    <head>
        ...
        <% 
            ...
            List<cartBean> finalOrder = (List<cartBean>)session.getAttribute("finalOrder");
            Integer totalNew = (Integer)session.getAttribute("total");
        %>
    </head>
    <body>
        ...
        <div class="container" style="padding: 2em;">
            ...
            <h4> Order Status: <span>Paid </span></h4>
