        ...
        <div class="tastyburger-content">
            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Drink </div>
                    <div class="panel-body"> 
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/drink/coke.jpg" alt="coke">
                                    <div class="caption">
                                        <h3>Coke</h3>
                                         <h4>$2.00</h4>
                                         
                                        <p></p>
                                        <input type="hidden" name="burgerName" value="Coke" />
                                        <input type="hidden" name="burgerPrice" value="2" />
                                        <input type="hidden" name="pageName" value="drink" />
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/drink/fanta.jpg" alt="fanta">
                                    <div class="caption">
                                        <h3>Fanta</h3>
                                        <h4>$2.00</h4>
                                        <p></p>
                                        <input type="hidden" name="burgerName" value="Fanta" />
                                        <input type="hidden" name="burgerPrice" value="2" />
                                        <input type="hidden" name="pageName" value="drink" />
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/TastyBurger/img/drink/soda.jpg" alt="soda">
                                    <div class="caption">
                                        <h3>Soda</h3>
                                           <h4>$2.00</h4>
                                        <p></p>
                                        <input type="hidden" name="burgerName" value="Soda" />
                                        <input type="hidden" name="burgerPrice" value="2" />
                                        <input type="hidden" name="pageName" value="drink" />
                                        <p><input type="submit" class="btn btn-primary" role="button" value="Add to Cart" /> </p>
                                    </div>
